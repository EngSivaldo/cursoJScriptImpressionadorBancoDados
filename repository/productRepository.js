...
class ProductRepository extends BaseRepository {
  ...
  async getAll() {
    try {
      const results = await super.getAll('product'); // Certifique-se de que o nome da tabela está correto
  ...
  async getById(id) {
    try {
      const result = await super.getById('product', id); // Certifique-se de que o nome da tabela está correto
